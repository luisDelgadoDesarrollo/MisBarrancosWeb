  ...
  <div v-else class="page-container">
    <div v-if="isMobileCheck()">
      <v-row class="mb-4" align-content="center" justify="space-between">
        ...
        <v-btn v-if="userPinia.isUserLogged && newCreatedByTheUserAuth()">Modificar evento</v-btn>
      </v-row>

      <a :href="newData?.link" target="_blank" class="mb-4">Enlace al evento</a>
      ...
      <h2 class="mt-4">Organizador y fecha</h2>
      <p class="mb-4">
        {{ newData?.organizer }}
