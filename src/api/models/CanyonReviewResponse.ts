...
export function CanyonReviewResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CanyonReviewResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CanyonReviewResponseToJSONTyped(value?: CanyonReviewResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
